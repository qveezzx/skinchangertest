...
private:
    ...
    void visualsObject(auto&& configConversion)
    {
        ...
        configConversion.boolean(u8"Enabled", loadVariable<skins_vars::Enabled>(), saveVariable<skins_vars::Enabled>());
        configConversion.boolean(u8"ShowSkinSelector", loadVariable<skins_vars::ShowSkinSelector>(), saveVariable<skins_vars::ShowSkinSelector>());
        configConversion.endObject();

        configConversion.beginObject(u8"MusicKits");
        configConversion.boolean(u8"Enabled", loadVariable<music_kits_vars::Enabled>(), saveVariable<music_kits_vars::Enabled>());
        configConversion.uint(u8"SelectedKit", loadVariable<music_kits_vars::SelectedMusicKit>(), saveVariable<music_kits_vars::SelectedMusicKit>());
        configConversion.endObject();
