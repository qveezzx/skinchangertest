...
(function () {
  var createNavbar = function () {
    ...
    var skinsTabButton = $.CreatePanel('RadioButton', centerContainer, 'skins_button', {
      group: "SettingsNavBar",
      class: "content-navbar__tabs__btn",
      onactivate: "$.Osiris.navigateToTab('skins');"
    });

    $.CreatePanel('Label', skinsTabButton, '', { text: "Skins" });

    var musicKitsTabButton = $.CreatePanel('RadioButton', centerContainer, 'musickits_button', {
      group: "SettingsNavBar",
      class: "content-navbar__tabs__btn",
      onactivate: "$.Osiris.navigateToTab('musickits');"
    });

    $.CreatePanel('Label', musicKitsTabButton, '', { text: "Music Kits" });
...
u8R"(
  ...
  var skins = createTab('skins');
  
  var skinsSection = createSection(skins, 'Weapon Skins');
  separator(skinsSection);
  createYesNoDropDown(skinsSection, "Enable Skin Changer", 'skins', 'enabled');

  var musicKits = createTab('musickits');
  
  var musicKitsSection = createSection(musicKits, 'Music Kits');
  separator(musicKitsSection);
  createDropDown(musicKitsSection, "Select Music Kit", 'musickits', 'selected_kit', [
    'Counter-Strike 2', 'Valve CSGO 2 (hidden)', 'Crimson Assault', 'Sharpened', 'Insurgency', 'A_D_8', 
    'High Noon', "Death's Head Demolition", 'Desert Fire', 'LNOE', 'Metal', 'All I Want For Christmas', 
    'Iso Rhythm', 'For No Mankind', 'Hotline Miami', 'The 8-Bit Kit', 'The Talos Principle', 'Battlepack', 
    'Molotov', 'Uber Blasto Phone', 'Hazardous Environments', 'Headshot', 'Total Domination', 'I Am', 
    'Diamonds', 'Invasion!', "Lion's Mouth", 'Sponge Fingerz', 'Aggressive', 'Java Havana Funkaloo', 
    'Moments CSGO', 'Disgusting', 'The Good Youth', 'FREE', "Life's Not Out To Get You", 'Backbone', 
    'GLA', 'Arena', 'EZ4ENCE', 'Halo', 'King, Scar', 'Anti-Citizen', 'Bachram', 'Taco Truck', 
    'Eye of the Dragon', 'M.U.D.D. FORCE', 'Neo Noir', 'Bodacious', 'Drifter', 'All For Dust', 
    'Hades', 'The Lowfile Pack', 'CHAINSAW Lxadxut', 'Mocha Petal', 'Yellow Magic', 'VICI', 
    'Atro Bellum', 'Work Hard, Play Hard', 'Kolibri', 'U Mad!', 'Flashbang Dance', 'Heading For The Source', 
    'Void', 'Shooters', 'Dashstar*', 'Gothic Luxury', 'Lock Me Up', 'Hua Lian', 'Ultimate', 'CS:GO', 'Under Bright Lights'
  ]);
